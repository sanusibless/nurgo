...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('assets/images/logo.png') }}" size="30x30" rel="icon">
...
<body>
        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card justify-content-center">
                <div class="card-body">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Nurgo Int'l Plc</span></strong>. All Rights Reserved
    </div>
  </footer><!-- End Footer -->
